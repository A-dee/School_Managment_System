...
class StudentCreate(BaseModel):
    ...
    parent_link_mode:  Literal["GUARDIAN_ONLY", "EXISTING_PARENT", "NEW_PARENT_PORTAL"] = "GUARDIAN_ONLY"
    existing_parent_id: Optional[int] = Field(None, gt=0)
...
class StudentParentPortalCreate(BaseModel):
    existing_parent_id: Optional[int] = Field(None, gt=0)
    guardian_name: Optional[str] = Field(None, max_length=200)
    guardian_phone: Optional[str] = Field(None, max_length=25)
    guardian_email: Optional[str] = Field(None, max_length=200)
