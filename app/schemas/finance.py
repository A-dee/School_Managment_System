...
from app.models.finance import InvoiceStatus, ExpenseApprovalStatus, PayrollStatus, PaymentDeclarationStatus, PaystackTransactionStatus, FeeStructureTarget
...
class FeeStructureCreate(BaseModel):
    ...
    target_group:  FeeStructureTarget = FeeStructureTarget.ALL
...
class FeeStructureOut(BaseModel):
    ...
    session_id:    int
    term_id:       int
    target_group:  FeeStructureTarget
    fee_breakdown: dict
    total_fee:     Decimal
    created_at:    datetime
