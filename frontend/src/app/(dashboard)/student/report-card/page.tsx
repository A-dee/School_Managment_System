    ...
    <div style={{ fontFamily: "Arial, sans-serif", fontSize: 11, color: "#000" }}>
      ...
      <div style={{ marginBottom: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, padding: "10px 14px 8px", border: "2px solid #e0e0e0", borderTop: "none", borderBottom: "none" }}>
          ...
          <img src="/hope-hills-logo.png" alt="Hope Hills Academy" style={{ width: 80, height: 80, objectFit: "contain", flexShrink: 0 }} />
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
        ...
        <div>
          ...
          <span style={{ borderBottom: "1px solid #000", display: "inline-block", minWidth: 100, paddingBottom: 1 }}>{card.next_term_begins ?? ""}</span>
        </div>
        <div style={{ textAlign: "center" }}>
