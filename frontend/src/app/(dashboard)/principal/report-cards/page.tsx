    ...
    <div style={{ fontFamily: "Arial, sans-serif", fontSize: 11, color: "#000" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
        ...
        <div>
          ...
          <span style={{ borderBottom: "1px solid #000", display: "inline-block", minWidth: 100, paddingBottom: 1 }}>{meta.next_term_begins ?? ""}</span>
        </div>
        <div style={{ textAlign: "center" }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <section>
        ...
        <div style={{ maxWidth: 320 }}>
          ...
          <input type="text" placeholder="e.g. 10th January, 2026"
