          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                {(Object.entries(ANNOUNCEMENT_PRIORITY_META) as [AnnouncementPriority, typeof ANNOUNCEMENT_PRIORITY_META[AnnouncementPriority]][]).map(([priority, meta]) => {
      ...
      {loading ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {list.map((announcement) => {
            ...
            const isCalendarEvent = announcement.source === "CALENDAR_EVENT";
            return (
              <div
                key={announcement.id}
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", marginBottom: 3 }}>
                    ...
                    <span style={{ padding: "1px 9px", borderRadius: 20, fontSize: "0.68rem", fontWeight: 700, background: priorityMeta.bg, color: priorityMeta.color }}>
                    ...
                    {isCalendarEvent && (
                      <span style={{ padding: "1px 9px", borderRadius: 20, fontSize: "0.68rem", background: "rgba(14, 165, 233, 0.12)", color: "#0ea5e9", fontWeight: 700 }}>
                        Calendar Event
                      </span>
                    )}
                  </div>
