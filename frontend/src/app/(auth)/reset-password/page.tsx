...
function ResetPasswordForm() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#0f172a" }}>
      <div style={{ background: "#fff", borderRadius: 14, padding: "36px 32px", width: "100%", maxWidth: 400, boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
        {done ? (
          <>
          ...
          <>
            ...
            <p style={{ color: "#64748b", fontSize: "0.8125rem", marginBottom: 24 }}>Choose a strong password for your account.</p>
